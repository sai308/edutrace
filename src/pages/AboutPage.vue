...
import {
    ExternalLink, Github, Heart, Shield, Zap, Globe,
    Database, Code2, BookOpen
...
interface Technology {
    ...
    link: string;
    iconColor: string;
    iconType: 'vue' | 'vite' | 'tailwind' | 'shadcn' | 'svg' | 'component';
    icon?: any;
    iconClassName?: string;
    svgPath?: string;
    svgSecondaryPath?: string;
    svgCircle?: boolean;
    svgRect?: boolean;
    svgCircleCross?: boolean;
}
...
const technologies: Technology[] = [
    ...
    },
    {
        ...
        iconColor: 'bg-sky-400/10', // Adjusted background to match Tailwind mark
        iconType: 'tailwind' // Specific type for the wide logo
    },
    {
        name: 'shadcn-vue',
        description: 'Beautifully designed components built with Radix Vue and Tailwind',
        link: 'https://www.shadcn-vue.com/',
        iconColor: 'bg-[#41B883]/10',
        iconType: 'shadcn'
    },
    {
        name: 'Vue Router',
    ...
    {
        name: 'Vue I18n',
        description: 'Internationalization plugin for Vue.js (English & Ukrainian)',
    ...
    {
        name: 'IDB (IndexedDB)',
        description: 'Promise-based wrapper for browser IndexedDB storage',
    ...
    {
        name: 'PapaParse',
        description: 'Powerful CSV parser for parsing Google Meet reports',
    ...
    {
        name: 'Lucide Vue',
        description: 'Beautiful & consistent icon library for Vue applications',
        link: 'https://lucide.dev/',
        iconColor: 'bg-[#f56565]/10',
        iconType: 'svg',
        svgCircleCross: true
    },
    {
...
<template>
    <div class="max-w-4xl mx-auto space-y-12 pb-12 px-4">
        <div class="text-center space-y-4">
            <h1 class="text-4xl font-bold tracking-tight">{{ t('about.hero.title') }}</h1>
        ...
        <div class="space-y-6">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-2xl font-bold">{{ t('about.goals.title') }}</h2>
            </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <Card class="shadow-sm">
                    <CardHeader class="flex flex-row items-center gap-2 space-y-0 pb-3">
                        ...
                        <CardTitle class="text-base font-semibold">{{ t('about.goals.privacyFirst.title') }}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p class="text-sm text-muted-foreground">{{ t('about.goals.privacyFirst.description') }}</p>
                    </CardContent>
                </Card>
                ...
                <Card class="shadow-sm">
                    <CardHeader class="flex flex-row items-center gap-2 space-y-0 pb-3">
                        ...
                        <CardTitle class="text-base font-semibold">{{ t('about.goals.simplifyWorkflow.title') }}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p class="text-sm text-muted-foreground">{{ t('about.goals.simplifyWorkflow.description') }}</p>
                    </CardContent>
                </Card>
                ...
                <Card class="shadow-sm">
                    <CardHeader class="flex flex-row items-center gap-2 space-y-0 pb-3">
                        ...
                        <CardTitle class="text-base font-semibold">{{ t('about.goals.accessibleFree.title') }}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p class="text-sm text-muted-foreground">{{ t('about.goals.accessibleFree.description') }}</p>
                    </CardContent>
                </Card>
                ...
                <Card class="shadow-sm">
                    <CardHeader class="flex flex-row items-center gap-2 space-y-0 pb-3">
                        ...
                        <CardTitle class="text-base font-semibold">{{ t('about.goals.offlineCapable.title') }}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p class="text-sm text-muted-foreground">{{ t('about.goals.offlineCapable.description') }}</p>
                    </CardContent>
                </Card>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-2xl font-bold">{{ t('about.technologies.title') }}</h2>
            </div>

            <Card class="overflow-hidden border shadow-sm">
                <div class="divide-y divide-border">
                    <div v-for="tech in technologies" :key="tech.name"
                        class="p-4 hover:bg-muted/50 transition-colors group">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div
                                    :class="['size-10 rounded-lg flex items-center justify-center shrink-0 p-1', tech.iconColor]">
                                    ...
                                    <template v-if="tech.iconType === 'vue'">
                                        <svg viewBox="0 -17.5 256 256" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <template v-if="tech.iconType === 'vite'">
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none">
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                ...
                                                <defs id="defs50">
                                                    <linearGradient id="paint0_linear" x1="6.0002" y1="32.9999" x2="235"
                                    ...
                                    <template v-else-if="tech.iconType === 'shadcn'">
                                        <svg viewBox="0 0 256 256" class="size-5" style="color:#41B883;">
                                    ...
                                    <template v-else-if="tech.iconType === 'svg'">
                                        <svg class="size-6" viewBox="0 0 24 24" fill="none">
                                            <template v-if="tech.svgPath">
                                                <path :d="tech.svgPath"
                                                    :stroke="tech.name === 'Vite' ? '#646cff' : '#42b883'"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    :fill="tech.name === 'Vite' ? '#646cff' : 'none'" />
                                                <path v-if="tech.svgSecondaryPath" :d="tech.svgSecondaryPath"
                                                    stroke="#ffc517" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <circle v-if="tech.svgCircle" cx="12" cy="12" r="2" fill="#42b883" />
                                            </template>
                                            <template v-if="tech.svgRect">
                                                <rect x="3" y="3" width="18" height="18" rx="2" stroke="#10b981"
                                                    stroke-width="2" />
                                                <path d="M3 9h18M3 15h18M9 3v18M15 3v18" stroke="#10b981"
                                                    stroke-width="2" />
                                            </template>
                                            <template v-if="tech.svgCircleCross">
                                                <circle cx="12" cy="12" r="10" stroke="#f56565" stroke-width="2" />
                                                <path d="M8 12h8M12 8v8" stroke="#f56565" stroke-width="2"
                                                    stroke-linecap="round" />
                                            </template>
                                        </svg>
                                    </template>

                                    <component v-else :is="tech.icon" :class="['size-5', tech.iconClassName]" />
                                </div>
                                <div>
                                    <h3 class="font-semibold text-sm sm:text-base">{{ tech.name }}</h3>
                                    <p class="text-xs sm:text-sm text-muted-foreground">{{ tech.description }}</p>
                                </div>
                            </div>
                            <Button variant="ghost" size="icon"
                                class="shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" as-child>
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <Card class="bg-card/50 shadow-sm">
                <CardHeader>
                ...
                <CardContent class="space-y-4">
                    <p class="text-sm text-muted-foreground leading-relaxed">
                        {{ t('about.guide.description') }}
                    </p>
                    <Button class="w-full font-semibold" as-child>
                        <router-link to="/guide">
                            <BookOpen class="mr-2 size-4" />
                            {{ t('about.guide.button') }}
                        </router-link>
                    </Button>
                </CardContent>
            </Card>
        ...
        <div class="text-center pt-8 space-y-4">
            <p class="text-sm text-muted-foreground font-medium flex items-center justify-center gap-1.5 pt-4">
                Built with
                <Heart class="size-4 text-destructive fill-destructive animate-pulse" /> for educators
            </p>
        </div>
    </div>
</template>